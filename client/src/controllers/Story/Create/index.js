		...
		<form>
			<div className='story-img'>
				<div
					...
					style={storyImg ? { background: `url(${storyImg})` } : {}}
				/>
			</div>
				...
				{...{
					...
					onClick: e => {
                        ...
                        ${
													formInfo.occupation.length >= 3
														? ''
														: 'Occupation must be longer than 3 characters.'
												}
                        `)
							...
							setFormInfo({
								...
								name_f:
									formInfo.name && formInfo.name.length >= 3 ? true : false,
								occupation_f:
									formInfo.occupation && formInfo.occupation.length >= 3
										? true
										: false,
							})
						}
