...
const editEntry = async (storyId, entryId, entryInfo, headers) => {
    return await axios.put(`${baseUrl}/stories/${storyId}/entries/edit/${entryId}`, entryInfo, {headers: headers})
}

const createEntry = async (storyId, entryInfo, headers) => {
    return await axios.post(`${baseUrl}/stories/${storyId}/entries`, entryInfo, {headers: headers})
}

const deleteEntry = async (storyId, entryId, headers) => {
    return await axios.delete(`${baseUrl}/stories/${storyId}/entries/${entryId}`, {headers: headers})
}
...
const deleteProfile = async (profileId, headers) => {
    return await axios.delete(`${baseUrl}/profile/${profileId}`, {headers: headers})
}

const editProfile = async (profileInfo, headers) => {
    return await axios.put(`${baseUrl}/profile/${profileInfo.id}`, profileInfo, {headers: headers})
}
...
const getForeignEntries = async (userId, headers) => {
    return await axios.get(`${baseUrl}/profile/${userId}/manage`, {headers: headers})
}
...
const setInspired = async (storyId, headers) => {
    return await axios.post(`${baseUrl}/stories/${storyId}/inspire`, null, {headers: headers})
}
...
const searchDate_full = async (m, d, y) => {
    return await axios.get(`${baseUrl}/search/entries/date?year=${y}&month=${m}&day=${d} `)
}
